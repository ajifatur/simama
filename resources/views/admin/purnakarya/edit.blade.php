        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.purnakarya.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-2 col-md-3 col-form-label"><span id="label-tanggal">{{ $purnakarya->status == 1 ? 'TMT Pensiun' : 'Tanggal Meninggal Dunia'}} </span> <span class="text-danger">*</span></label>
                        <div class="col-lg-10 col-md-9">
