...
@section('title', 'Kelola Purnakarya Aktif')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-2 mb-sm-0">Kelola Purnakarya Aktif</h1>
</div>
<div class="row">
	<div class="col-12">
		<div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{ \Ajifatur\Helpers\DateTimeExt::change($p->tmt_pensiun) }}
                                </td>
                                <td align="center">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.purnakarya.inactivate', ['id' => $p->id]) }}" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" title="Nonaktifkan"><i class="bi-x-circle"></i></a>
