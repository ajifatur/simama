...
@section('title', 'Alamat Purnakarya')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-2 mb-sm-0">Alamat Purnakarya: {{ $purnakarya->nama }}</h1>
</div>
<div class="row">
	<div class="col-12">
		<div class="card">
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('admin.purnakarya.address.update') }}">
                    @csrf
                    <input type="hidden" name="purnakarya_id" value="{{ $purnakarya->id }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover table-bordered mb-0" id="table">
                            ...
                            <tbody>
                                @foreach($purnakarya->alamat()->orderBy('created_at','desc')->get() as $key=>$a)
...
<form class="form-delete d-none" method="post" action="{{ route('admin.purnakarya.address.delete') }}">
    @csrf
