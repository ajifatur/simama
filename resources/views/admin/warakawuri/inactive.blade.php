...
@section('title', 'Kelola Warakawuri MD')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-2 mb-sm-0">Kelola Warakawuri MD</h1>
</div>
<div class="row">
	<div class="col-12">
		<div class="card">
                    ...
                    <table class="table table-sm table-hover table-bordered" id="datatable">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th width="100">Tanggal MD Ybs</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="d-none">{{ $w->tanggal_md }}</span>
                                    {{ \Ajifatur\Helpers\DateTimeExt::change($w->tanggal_md) }}
                                </td>
                                <td>
                                ...
                                <td align="center">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.warakawuri.edit', ['id' => $w->id]) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit"><i class="bi-pencil"></i></a>
