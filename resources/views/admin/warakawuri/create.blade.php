...
@section('title', 'Tambah Warakawuri')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah Warakawuri</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.warakawuri.store') }}" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title">Identitas Pegawai</h5>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-2 col-md-3 col-form-label">Tanggal Meninggal Dunia <span class="text-danger">*</span></label>
                        <div class="col-lg-10 col-md-9">
                    ...
                    <hr>
                    <div class="row mb-3" id="nama-warakawuri">
                        <label class="col-lg-2 col-md-3 col-form-label">Nama Warakawuri</label>
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="nama_warakawuri" class="form-control form-control-sm" value="{{ old('gender') != null ? old('gender') == 'L' ? 'Ibu' : 'Bapak' : '' }} {{ old('nama') }}" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<script>
    ...
    function setNamaWarakawuri() {
        var nama = $("input[name=nama]").val();
        var gender = $("input[name=gender]:checked").val();
        if(nama != '') {
            if(gender == 'L') $("input[name=nama_warakawuri]").val("Ibu " + nama);
            else if(gender == 'P') $("input[name=nama_warakawuri]").val("Bapak " + nama);
            else $("input[name=nama_warakawuri]").val("");
        }
        else $("input[name=nama_warakawuri]").val("");
    }
</script>
